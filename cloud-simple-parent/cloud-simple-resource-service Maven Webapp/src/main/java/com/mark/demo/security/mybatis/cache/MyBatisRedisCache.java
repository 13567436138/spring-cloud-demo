...
import com.mark.demo.security.service.ResourceRedisFeignService;
...
public class MyBatisRedisCache implements Cache,Serializable{
	...
	private ResourceRedisFeignService resourceRedisFeignService;
	...
	public ResourceRedisFeignService getResourceRedisFeignService() {
		if(resourceRedisFeignService==null){
			resourceRedisFeignService=SpringUtils.getBean(ResourceRedisFeignService.class);
		}
		return resourceRedisFeignService;
	}
	...
	public void putObject(Object key, Object value) {
		...
		if(value instanceof List){
			if(myKey.indexOf("ResourceMapper")!=-1){
				getResourceRedisFeignService().setMapFieldMenu(mybatis_cache_prefix+myKey, cacheKey.toString(),(List<Resource>)value);
			}
		}
	}
	@Override
